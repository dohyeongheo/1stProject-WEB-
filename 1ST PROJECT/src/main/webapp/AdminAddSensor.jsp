...
#body-content {
	margin-top: 100px;
	padding-bottom: 184px; /* footer의 높이 */
}

footer {
	width: 100%;
	height: 184px; /* footer의 높이 */
	position: absolute;
	bottom: 0;
	left: 0;
}
...
<body class="text-center bg-secondary bg-opacity-10">
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown"><a
						...
						role="button" data-bs-toggle="dropdown" aria-expanded="false">
							MyPage </a>
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							<li><a class="dropdown-item" href="UserMemberUpdate.jsp">내
									정보 수정</a></li>
	...
	<form action="AddDeviceSensorServicecon.do" method="get"
		...
		<div class="row" style="margin-top: 20px;">
			<div class="col">
				...
				<input type="text" class="form-control" name="device_uid"
					placeholder="디바이스 아이디">
			</div>
			<div class="col">
				<h5>창고 소유회원 아이디 입력</h5>
				<input type="text" class="form-control" name="mem_id"
					placeholder="창고 소유회원 아이디">
			</div>
			<div class="col">
				<h5>디바이스 설치장소 입력</h5>
				<input type="text" class="form-control" name="device_loc"
					placeholder="디바이스 설치장소">
			</div>
			<div class="col">
				<h5>디바이스 설치일자 입력</h5>
				<input type="date" class="form-control" name="device_inst_date"
					placeholder="디바이스 설치일자">
			</div>
		</div>
		...
		<div class="container" style="margin-top: 50px">
			...
			<button type="button" class="btn btn-primary" id="addSensor">센서
				추가</button>
		</div>
