...
<body>
	...
	<div class="container" style="margin-top: 100px;">
		<div class="row">
			<div class="col-md-6">
				<h1 class="text-center">전화번호 수정</h1>
			</div>
			<div class="col-md-6">
		...
		<div class="row mx-auto text-center" style="height: 500px; margin-top : 20px">
			<div class="col-md-6">
			<form>
					<div class="form-floating mb-3 mx-auto w-50" style="margin-top:50px">
						<input type="text" class="form-control" name="mem_name" placeholder="기존 전화번호 입력 (Ex 010-0000-0000))">
						<label for="exampleInputPassword1" class="form-label">변경전 전화번호 입력</label>
					</div>
					
					
					<div class="form-floating mb-3 mx-auto w-50">
						 <input type="text" class="form-control" name="mem_phone" placeholder="변경할 전화번호 입력">
						<label for="exampleInputPassword1" class="form-label">변경할 전화번호 입력</label>
					</div>

					<button type="button" id="changename" class="btn btn-primary" style="margin-top:25px;">전화번호 변경</button>
					<button type="reset" class="btn btn-primary" style="margin-top:25px;">입력창 초기화</button>
					</form>
				<p class="changenameresult"></p>
			</div>

			<div class="col-md-6">
			<form>
					<div class="form-floating mb-3 mx-auto w-50" style="margin-top:50px">
						<input type="password" class="form-control" name="mem_name" placeholder="기존 전화번호 입력 (Ex 010-0000-0000))">
						<label for="exampleInputPassword1" class="form-label">변경전 비밀번호 입력</label>
					</div>
					
					
					<div class="form-floating mb-3 mx-auto w-50">
						 <input type="password" class="form-control" name="mem_phone" placeholder="변경할 전화번호 입력">
						<label for="exampleInputPassword1" class="form-label">변경할 비밀번호 입력</label>
					</div>
					<div class="form-floating mb-3 mx-auto w-50">
						 <input type="password" class="form-control" name="mem_phone" placeholder="변경할 전화번호 입력">
						<label for="exampleInputPassword1" class="form-label">변경할 비밀번호 재입력</label>
					</div>

					<button type="button" id="changepw" class="btn btn-primary" style="margin-top:25px;">비밀번호 변경</button>
					<button type="reset" class="btn btn-primary" style="margin-top:25px;">입력창 초기화</button>
					</form>
