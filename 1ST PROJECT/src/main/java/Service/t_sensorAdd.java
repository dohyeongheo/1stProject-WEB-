...
public class t_sensorAdd implements Command {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response)
		...
		// 센서 데이터 추가 기능
		System.out.println("[t_sensorAddServiceCon]");
		String nextpage = "";
		...
		// 2. 데이터 받아오기
		String[] sensor_type = request.getParameterValues("sensor_type");
		String[] sensor_unit = request.getParameterValues("sensor_unit");
		String[] sensor_inst_date = request.getParameterValues("sensor_inst_date");
...
//		MemberDTO dto = new MemberDTO(mem_id, mem_pw, mem_name, mem_phone, mem_joindate, mem_type);
		...
		// 5. 실행결과 확인
		if (cnt > 0) {
			System.out.println("T_sensor add 성공하였습니다.");
		...
		// Session.setAttribute("mem_name", mem_name);
			...
			System.out.println("T_sensor add 실패하였습니다.");
			nextpage = "goMain";
		}
